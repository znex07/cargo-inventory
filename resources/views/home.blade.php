        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <button class="create-modal btn btn-info" data-info="">Add Cargo</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-body ">
                <div class="form-horizontal px-5 align-middle">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8"><input type="text"  class="form-control" id="cargo_status" placeholder=""/></div>
                    </div>
                    <div class="form-group row">
